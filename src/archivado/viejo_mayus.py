...
from utils.colors import BACKGROUND_COLOR, BLANCO, VERDE, ROJO
...
class MayusculasScene:
    ...
    def draw_aprende(self):
        ...
        if self.mostrar_feedback:
            draw_text_centered(self.screen, self.mostrar_feedback, self.assets.fonts['small'], HEIGHT - 40, color=color)
